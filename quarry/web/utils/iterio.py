# -*- coding: utf-8 -*-
r"""
    File copied from werkzeug.contrib.iterio as it was deleted in original library
    https://raw.githubusercontent.com/pallets/werkzeug/0c487f76985574012d63b3ebae2d6a0ef6d41f60/src/werkzeug/contrib/iterio.py
    It is possible to integrate this BSD file into our MIT repo
    ~~~~~~~~~~~~~~~~~~~~~~~
